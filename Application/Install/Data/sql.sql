...
CREATE TABLE `app_member` (
  ...
  `status` int(1) NOT NULL DEFAULT '0' COMMENT '0:帐号未激活 1:帐号激活',
  PRIMARY KEY (`memberid`),
  KEY `username` (`username`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `app_craftsman`;
CREATE TABLE `app_craftsman` (
  `craftsmanid` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `username` varchar(30) NOT NULL COMMENT '帐号',  
  `password` varchar(32) NOT NULL,
  ...
  `realname` varchar(50) DEFAULT NULL comment '真实姓名',	
	...
	`province` varchar(255) DEFAULT NULL comment '服务省份',
	`city` varchar(255) DEFAULT NULL comment '服务城市',
	`area` varchar(255) DEFAULT NULL comment '服务地区',
	`craftsmanship` int(32) DEFAULT '0' comment '技能', 
	`infostatus` int(10) DEFAULT '0' comment '0:身份未验证1身份已验证',
	 `status` int(1) NOT NULL DEFAULT '0' COMMENT '0:帐号未激活 1:帐号激活',
	 `credibility` int(2) DEFAULT '10' COMMENT '10:初始值 0:不能参与抢单',
  PRIMARY KEY (`craftsmanid`),
  KEY `username` (`username`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `app_order` (
	...
	`craftsmanid` int(11) DEFAULT '0' comment '接单工匠',	
	`score` int(2) DEFAULT '10' comment '服务评分',
	`comment` text comment '服务评价',
	`iscommented` int(1) DEFAULT '0' comment '0:没有评价1:已经评价',
    PRIMARY KEY (`id`)
)ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `app_service` (	
	...
	`picture` varchar(255) DEFAULT '' comment '图片名称',
...
DROP TABLE IF EXISTS `app_service_craftsmanship`;
CREATE TABLE IF NOT EXISTS `app_service_craftsmanship` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sid` int(11) NOT NULL COMMENT '服务项目id',
  `cid` int(11) NOT NULL COMMENT '技能id',
  `status` tinyint(2) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='服务、技能对应表' AUTO_INCREMENT=1 ;

INSERT INTO `app_service_craftsmanship`(`id`,`sid`,`cid`,`status`) VALUES
(1,1,1,1),
(2,2,2,1),
(3,11,1,1),
(4,3,3,1),
...
INSERT INTO `app_service`(`serviceid`, `servicename`, `price`, `status`, `picture`) VALUES
(1,"家庭清洁", 100, 1, "01.jpg"), 
(2,"油烟机清洗", 50, 1, "02.jpg"), 
(3,"马桶修理", 30, 1, "03.jpg"),
(4,"水电维修", 150, 1, "04.jpg"),
